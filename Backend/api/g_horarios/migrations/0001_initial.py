# Generated by Django 4.2.12 on 2024-05-06 17:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='g_horarios.usuario')),
            ],
        ),
        migrations.CreateModel(
            name='Horario',
            fields=[
                ...
                ('asignatura_cod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='g_horarios.asignatura')),
                ('aula_cod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='g_horarios.aula')),
                ('grupo_cod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='g_horarios.grupo')),
            ],
        ),
        migrations.CreateModel(
            name='Ausencia',
            fields=[
                ...
                ('asignatura_cod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='g_horarios.asignatura')),
                ('horario_cod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='g_horarios.horario')),
                ('profesor_cod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='g_horarios.profesor')),
            ],
        ),
    ]
